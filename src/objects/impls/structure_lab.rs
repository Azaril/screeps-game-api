...
extern "C" {
    ...
    pub fn boost_creep(this: &StructureLab, creep: &Creep, body_part_count: Option<u32>) -> ReturnCode;
    ...
    pub fn reverse_reaction(this: &StructureLab, lab1: &StructureLab, lab2: &StructureLab) -> ReturnCode;
    ...
    pub fn run_reaction(this: &StructureLab, lab1: &StructureLab, lab2: &StructureLab) -> ReturnCode;
